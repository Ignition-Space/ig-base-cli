 ...
 * @LastEditors: Cookie
 * @LastEditTime: 2021-07-04 22:54:08
 * @Description:
 */
...
var getRePath = function (path) {
    return util_1.getDirPath("../../node_modules/" + path);
};
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    error_1 = _a.sent();
                    process.exitCode = 1;
                    util_1.failed(error_1);
                    return [3 /*break*/, 6];
                case 5:
                    util_1.countTime('Eslint 校验', false);
                    return [7 /*endfinally*/];
